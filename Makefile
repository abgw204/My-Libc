...
FUNCTIONS = ft_strdup.c ft_strlen.c ft_strncmp.c ft_isprint.c ft_tolower.c ft_isalpha.c ft_isdigit.c ft_strnstr.c ft_substr.c ft_strtrim.c ft_itoa.c ft_putnbr_fd.c
OBJS = ft_strdup.o ft_strlen.o ft_strncmp.o ft_isprint.o ft_tolower.o ft_isalpha.o ft_isdigit.o ft_strjoin.o ft_strtrim.o ft_itoa.o ft_putstr_fd.o ft_putnbr_fd.o
