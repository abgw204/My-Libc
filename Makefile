...
FUNCTIONS1 = ft_toupper.c ft_isascii.c ft_atoi.c ft_isalnum.c ft_strchr.c ft_strlcpy.c ft_strrchr.c ft_strjoin.c ft_calloc.c ft_putstr_fd.c ft_putchar_fd.c ft_memcmp.c ft_memmove.c ft_memset.c ft_bzero.c
OBJS1 = ft_toupper.o ft_isascii.o ft_atoi.o ft_isalnum.o ft_strchr.o ft_strlcpy.o ft_strrchr.o ft_strnstr.o ft_substr.o ft_calloc.o ft_putchar_fd.o ft_memchr.o ft_memcpy.o ft_memmove.o ft_bzero.o
NAME = libft.a
